  ...
  return (
    <header className='flex flex-col gap-3'>
      ...
      <div className='flex flex-col gap-3 lg:flex-row lg:justify-between'>
        ...
        <button className='hover:cursor-pointer hover:bg-gray-800/60 transition-colors border max-w-fit border-gray-600 flex gap-3 items-center rounded-2xl bg-gray-800 py-1 px-5 text-white'>
          <svg
